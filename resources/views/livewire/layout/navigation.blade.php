...
{{--                </x-responsive-nav-link>--}}
    ...
    <!-- Navigation Links -->
    {{-- MOBILE --}}{{-- space-x-8 sm:-my-px sm:ms-10 sm:flex --}}
    <div class="sm:hidden justify-around flex " >
        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')" wire:navigate title="bio">
            {{-- heroicons:user --}}
