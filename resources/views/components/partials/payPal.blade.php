...
>
    ...
    <div class="flex flex-row space-x-2">
        ...
        <div class="">${{ number_format(isset($rehearsal) && $rehearsal['participationAmountDue'] ? $rehearsal['participationAmountDue'] : $amountDue, 2) }}</div>
    </div>

    <!-- Identify your business so that you can collect the payments. -->
    <input type="hidden" name="business" value="{{ $sandbox ? $sandboxId : $form->ePaymentId }}">
    <input type="hidden" name="notify_url"
           value="https://thedirectorsroom.com/webhook/paypal" >
    {{-- ($sandbox) ? 'https://thedirectorsroom.com/webhook/paypal' : 'https://thedirectorsroom.com/epaymentUpdate' --}}
    ...
    <input type="hidden" name="amount" value="{{ isset($rehearsal) && $rehearsal['participationAmountDue'] ? $rehearsal['participationAmountDue'] : $amountDue }}">
