...
console.log('accessId: ' + accessToken);
...
{{--<div>config:AppId:  {{ config('app.squareSandboxApplicationId') }}</div>--}}
{{--<div>config: LocationID: {{ config('app.squareSandboxLocation') }}</div>--}}
{{--<div>config: AccessToken: {{ config('app.squareAccessToken') }}</div>--}}
    <form id="payment-form" class="">
        <div id="card-container"></div>
        <div class="text-sm">If the card number form does not display, refresh the page.</div>
        <button id="card-button" type="button" class="square">Pay ${{ number_format($amountDue, 2) }}</button>
    </form>
